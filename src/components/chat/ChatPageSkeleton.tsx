import { ImageIcon, MessageIcon } from "@/assets/icons/components";
...
function SidebarSkeleton() {
  return (
    <aside className="flex min-h-0 w-full shrink-0 flex-col overflow-hidden bg-black md:w-[300px] md:border-r md:border-white/10">
...
function MainChatSkeleton() {
  return (
    <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-white">
      ...
      <div className="flex min-h-[100px] items-end justify-center gap-3 border-t border-gray-200 px-10 py-6">
        <div className="flex h-13 w-13 shrink-0 items-center justify-center rounded-full bg-gray-100 text-gray-400 transition hover:cursor-pointer hover:text-gray-600">
          <ImageIcon />
        </div>
        ...
        <textarea
          ...
          rows={1}
          className="style-body-2 max-h-50 min-h-10 flex-1 resize-none overflow-y-hidden px-4 py-2.5 outline-none placeholder:text-gray-400 focus:border-orange-400"
          readOnly
        />
