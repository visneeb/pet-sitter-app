  ...
  return (
    <div className="w-full md:w-[396px] md:rounded-2xl bg-white overflow-hidden shadow-[4px_4px_24px_0_rgba(0,0,0,0.04)]">
      <div className="text-sm">
        ...
        <div className="h-[304px] md:h-[328px] bg-white p-6 flex flex-col gap-4 lg:gap-6">
        <div>
      ...
      <div className="bg-black text-white px-6 py-6 flex justify-between style-body-2 h-[60px] md:h-[76px] items-center">
        <span>Total</span>
